...
<div id="page-content" class="category_view">
    <div class="collection-header">
        <div class="collection-hero">
            <div class="collection-hero__image"><img class="blur-up lazyload" data-src="{{ asset('fassets/images/cat-women1.jpg') }}" src="{{ asset('fassets/images/cat-women1.jpg') }}" alt="{{ $catnm }}" title="{{ $catnm }}" /></div>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-2 sidebar filterbar">
                ...
                <div class="sidebar_tags">
                                ...
                                @foreach ($categories as $category)
                                    @if ($category->parent == 0) 
                                        ...
                                        <li class="level1 @if($childCategories->isNotEmpty()) sub-level @endif">
                                            <a href="javascript:void(0);" class="site-nav">{{ $category->name }}</a>
                    ...
                    <div class="sidebar_widget static-banner">
                        <img src="{{ asset('fassets/images/side-banner-2.jpg') }}" alt="" />
                    </div>
                </div>
            </div>
