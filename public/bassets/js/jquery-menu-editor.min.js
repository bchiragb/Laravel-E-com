function MenuEditor(e, s) {
    ...
    function f(e, s) {
        ...
        return $.each(e, (function(e, s) {
            ...
            if (o.tag_color) {
               //d.append('<br><small>Tag Color: ' + o.tag_color + '</small>');  
            }
            if (o.tag_name) {
                //d.append('<br><small>Tag Name: ' + o.tag_name + '</small>');  
            }
            if (o.css_class) {
                //d.append('<br><small>CSS class: ' + o.css_class + '</small>');
            }
    ...
    t.sortableLists(l.listOptions), c.on("change", (function(e) {
        ...
        var tag_colorval = i.find("[name='tag_color']").val();  // Get custom field value
        e.tag_color = tag_colorval;  // Add the custom field value to the item data

        var tag_nameval = i.find("[name='tag_name']").val();  // Get custom field value
        e.tag_name = tag_nameval;  // Add the custom field value to the item data

        var css_classval = i.find("[name='css_class']").val();  // Get custom field value
        e.css_class = css_classval;  // Add the custom field value to the item data
